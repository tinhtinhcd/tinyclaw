...
import { getAgentDisplayName } from "@/lib/chat-types";
...
export default function AgentChatPage({
  ...
  const agentRole = agent
    ? (agent as AgentConfig & { role?: string }).role || getAgentDisplayName(id)
    : undefined;
    ...
    <div className="flex h-full flex-col">
      ...
      {agent && (
        <div className="flex items-center gap-3 border-b px-6 py-2.5 bg-card">
          <div className="flex h-8 w-8 items-center justify-center bg-primary/10 text-primary text-xs font-bold uppercase shrink-0 rounded">
