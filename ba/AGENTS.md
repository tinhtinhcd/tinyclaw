...
- `@ba` — **BA** (openai/gpt-4.1-mini)

### Your Teammates

- `@scrum_master` — **Scrum Master** (openai/gpt-4.1-mini)
- `@architect` — **Architect** (openai/gpt-4.1-mini)
- `@coder` — **Coder** (anthropic/claude-3.7-sonnet)
- `@reviewer` — **Reviewer** (openai/gpt-4.1-mini)
- `@tester` — **Tester** (openai/gpt-4.1-mini)
<!-- TEAMMATES_END -->
